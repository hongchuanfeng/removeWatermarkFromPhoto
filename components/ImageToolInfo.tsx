...
interface ImageToolInfoProps {
  toolKey: string // e.g., 'image_mosaic', 'image_compress', etc.
  exampleImages?: string[] // Optional custom example images for the tool
}

export default function ImageToolInfo({ toolKey, exampleImages }: ImageToolInfoProps) {
  const { t } = useLanguage()
