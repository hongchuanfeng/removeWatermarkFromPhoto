        ...
        {!selectedImage ? (
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <select value={scale} onChange={(e) => setScale(Number(e.target.value))} className="border border-gray-300 rounded-lg px-4 py-2">
            ...
            <div className="flex justify-center gap-4">
              ...
              <button onClick={handleProcess} disabled={isProcessing} className="px-6 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition disabled:opacity-50">
                {isProcessing ? t('enlarge_image.processing') : t('enlarge_image.enlarge')}
              </button>
            </div>
          </div>
        )}
