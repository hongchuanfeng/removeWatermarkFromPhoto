...
export default function ChangeBackground() {
  ...
  const handleDownload = () => {
    ...
    link.download = 'changed-background.png'
        ...
        {!selectedImage ? (
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-center gap-4">
              <label className="text-gray-700">{t('change_background.bg_color')}:</label>
              <input 
                type="color" 
                value={bgColor}
            ...
            <div className="flex justify-center gap-4">
              ...
              <button onClick={handleProcess} disabled={isProcessing} className="px-6 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700 transition disabled:opacity-50">
                {isProcessing ? t('change_background.processing') : t('change_background.change')}
              </button>
            </div>
          </div>
        )}
        ...
        {processedImage && (
          <div className="mt-8 pt-8 border-t border-gray-200">
            ...
            <div className="flex justify-center mb-6">
              <img src={processedImage} alt="Processed" className="max-w-full max-h-96 rounded-lg" style={{ backgroundColor: bgColor }} />
            </div>
            <div className="flex justify-center">
