...
interface AudioToolInfoProps {
  toolKey: string // e.g., 'audio_clip_merge', 'audio_format_conversion', etc.
  exampleImages?: string[] // Optional custom example images for the tool
}

export default function AudioToolInfo({ toolKey, exampleImages }: AudioToolInfoProps) {
  const { t } = useLanguage()
