      ...
      <div className="bg-white rounded-xl shadow-lg p-8">
        {!selectedImage ? (
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-center gap-4">
              ...
              >
                {isProcessing ? t('image_mosaic.processing') : t('image_mosaic.process')}
              </button>
            </div>
          </div>
        )}
        ...
        {processedImage && (
          <div className="mt-8 pt-8 border-t border-gray-200">
            <h3 className="text-xl font-semibold text-gray-900 mb-4 text-center">{t('image_mosaic.result')}</h3>
